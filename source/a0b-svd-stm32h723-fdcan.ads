...
package A0B.SVD.STM32H723.FDCAN is
   pragma Preelaborate;
   ...
   subtype CREL_DAY_Field is A0B.Types.SVD.Byte;
   subtype CREL_MON_Field is A0B.Types.SVD.Byte;
   subtype CREL_YEAR_Field is A0B.Types.SVD.UInt4;
   subtype CREL_SUBSTEP_Field is A0B.Types.SVD.UInt4;
   subtype CREL_STEP_Field is A0B.Types.SVD.UInt4;
   subtype CREL_REL_Field is A0B.Types.SVD.UInt4;
   ...
   subtype CCFG_TQBT_Field is A0B.Types.SVD.UInt5;
   subtype CCFG_OCPM_Field is A0B.Types.SVD.Byte;
   subtype CCFG_CDIV_Field is A0B.Types.SVD.UInt4;
   ...
   type CCFG_Register is record
      ...
      --  unspecified
      Reserved_20_30 : A0B.Types.SVD.UInt11 := 16#0#;
      --  Software Reset
      SWR            : Boolean := False;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype CSTAT_OCPC_Field is A0B.Types.SVD.UInt18;
   subtype CSTAT_TQC_Field is A0B.Types.SVD.UInt11;
   subtype CSTAT_CALS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CWD_WDC_Field is A0B.Types.SVD.UInt16;
   subtype CWD_WDV_Field is A0B.Types.SVD.UInt16;
   ...
   type FDCAN_DBTP_Register is record
      ...
      --  unspecified
      Reserved_21_22 : A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_TEST_TX_Field is A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_NBTP_TSEG2_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FDCAN_TSCC_TSS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_TOCC_TOS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_ECR_TREC_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FDCAN_PSR_LEC_Field is A0B.Types.SVD.UInt3;
   subtype FDCAN_PSR_ACT_Field is A0B.Types.SVD.UInt2;
   ...
   type FDCAN_IR_Register is record
      ...
      DRX            : Boolean;
      --  unspecified
      Reserved_20_21 : A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_GFC_ANFE_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_GFC_ANFS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_SIDFC_FLSSA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_SIDFC_LSS_Field is A0B.Types.SVD.Byte;
   ...
   subtype FDCAN_XIDFC_FLESA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_XIDFC_LSE_Field is A0B.Types.SVD.Byte;
   ...
   subtype FDCAN_HPMS_BIDX_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_HPMS_MSI_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_HPMS_FIDX_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FDCAN_RXF0C_F0SA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_RXF0C_F0S_Field is A0B.Types.SVD.Byte;
   subtype FDCAN_RXF0C_F0WM_Field is A0B.Types.SVD.Byte;
   ...
   subtype FDCAN_RXF0S_F0FL_Field is A0B.Types.SVD.UInt7;
   subtype FDCAN_RXF0S_F0G_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_RXF0S_F0P_Field is A0B.Types.SVD.UInt6;
   ...
   subtype FDCAN_RXF0A_FA01_Field is A0B.Types.SVD.UInt6;
   ...
   subtype FDCAN_RXBC_RBSA_Field is A0B.Types.SVD.UInt14;
   ...
   subtype FDCAN_RXF1C_F1SA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_RXF1C_F1S_Field is A0B.Types.SVD.UInt7;
   subtype FDCAN_RXF1C_F1WM_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FDCAN_RXF1S_F1FL_Field is A0B.Types.SVD.UInt7;
   subtype FDCAN_RXF1S_F1GI_Field is A0B.Types.SVD.UInt7;
   subtype FDCAN_RXF1S_F1PI_Field is A0B.Types.SVD.UInt7;
   subtype FDCAN_RXF1S_DMS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype FDCAN_RXF1A_F1AI_Field is A0B.Types.SVD.UInt6;
   ...
   subtype FDCAN_RXESC_F0DS_Field is A0B.Types.SVD.UInt3;
   subtype FDCAN_RXESC_F1DS_Field is A0B.Types.SVD.UInt3;
   subtype FDCAN_RXESC_RBDS_Field is A0B.Types.SVD.UInt3;
   ...
   subtype FDCAN_TXBC_TBSA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_TXBC_NDTB_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_TXBC_TFQS_Field is A0B.Types.SVD.UInt6;
   ...
   subtype FDCAN_TXFQS_TFFL_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_TXFQS_TFGI_Field is A0B.Types.SVD.UInt5;
   subtype FDCAN_TXFQS_TFQPI_Field is A0B.Types.SVD.UInt5;
   ...
   subtype FDCAN_TXESC_TBDS_Field is A0B.Types.SVD.UInt3;
   ...
   subtype FDCAN_TXEFC_EFSA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_TXEFC_EFS_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_TXEFC_EFWM_Field is A0B.Types.SVD.UInt6;
   ...
   subtype FDCAN_TXEFS_EFFL_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_TXEFS_EFGI_Field is A0B.Types.SVD.UInt5;
   ...
   type FDCAN_TXEFS_Register is record
      ...
      --  unspecified
      Reserved_13_23 : A0B.Types.SVD.UInt11 := 16#0#;
      --  Event FIFO Full.
      EFF            : Boolean := False;
   ...
   subtype FDCAN_TXEFA_EFAI_Field is A0B.Types.SVD.UInt5;
   ...
   subtype FDCAN_TTTMC_TMSA_Field is A0B.Types.SVD.UInt14;
   subtype FDCAN_TTTMC_TME_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FDCAN_TTRMC_RID_Field is A0B.Types.SVD.UInt29;
   ...
   subtype FDCAN_TTOCF_OM_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTOCF_LDSDL_Field is A0B.Types.SVD.UInt3;
   subtype FDCAN_TTOCF_IRTO_Field is A0B.Types.SVD.UInt7;
   subtype FDCAN_TTOCF_AWL_Field is A0B.Types.SVD.Byte;
   ...
   subtype FDCAN_TTMLM_CCM_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_TTMLM_CSS_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTMLM_TXEW_Field is A0B.Types.SVD.UInt4;
   subtype FDCAN_TTMLM_ENTT_Field is A0B.Types.SVD.UInt12;
   ...
   subtype FDCAN_TURCF_NCL_Field is A0B.Types.SVD.UInt16;
   subtype FDCAN_TURCF_DC_Field is A0B.Types.SVD.UInt14;
   ...
   subtype FDCAN_TTOCN_SWS_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTOCN_TMC_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CAN_TTGTP_NCL_Field is A0B.Types.SVD.UInt16;
   subtype CAN_TTGTP_CTP_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FDCAN_TTTMK_TM_Field is A0B.Types.SVD.UInt16;
   subtype FDCAN_TTTMK_TICC_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FDCAN_TTOST_EL_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTOST_MS_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTOST_SYS_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTOST_RTO_Field is A0B.Types.SVD.Byte;
   subtype FDCAN_TTOST_TMP_Field is A0B.Types.SVD.UInt3;
   ...
   subtype FDCAN_TURNA_NAV_Field is A0B.Types.SVD.UInt18;
   ...
   subtype FDCAN_TTLGT_LT_Field is A0B.Types.SVD.UInt16;
   subtype FDCAN_TTLGT_GT_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FDCAN_TTCTC_CT_Field is A0B.Types.SVD.UInt16;
   subtype FDCAN_TTCTC_CC_Field is A0B.Types.SVD.UInt6;
   ...
   subtype FDCAN_TTCPT_CT_Field is A0B.Types.SVD.UInt6;
   subtype FDCAN_TTCPT_SWV_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FDCAN_TTCSM_CSM_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FDCAN_TTTS_SWTDEL_Field is A0B.Types.SVD.UInt2;
   subtype FDCAN_TTTS_EVTSEL_Field is A0B.Types.SVD.UInt2;
   ...
   type CAN_CCU_Peripheral is record
      ...
      pragma Volatile_Full_Access (CREL);
      --  Calibration Configuration Register
      CCFG  : aliased CCFG_Register;
      pragma Volatile_Full_Access (CCFG);
      --  Calibration Status Register
      CSTAT : aliased CSTAT_Register;
      pragma Volatile_Full_Access (CSTAT);
      --  Calibration Watchdog Register
      CWD   : aliased CWD_Register;
      pragma Volatile_Full_Access (CWD);
      --  Clock Calibration Unit Interrupt Register
      IR    : aliased IR_Register;
      pragma Volatile_Full_Access (IR);
      --  Clock Calibration Unit Interrupt Enable Register
      IE    : aliased IE_Register;
      pragma Volatile_Full_Access (IE);
   end record
     with Volatile;
   ...
   type FDCAN_Peripheral is record
      ...
      pragma Volatile_Full_Access (FDCAN_GFC);
      --  FDCAN Standard ID Filter Configuration Register
      FDCAN_SIDFC  : aliased FDCAN_SIDFC_Register;
      pragma Volatile_Full_Access (FDCAN_SIDFC);
      --  FDCAN Extended ID Filter Configuration Register
      FDCAN_XIDFC  : aliased FDCAN_XIDFC_Register;
      pragma Volatile_Full_Access (FDCAN_XIDFC);
      --  FDCAN Extended ID and Mask Register
      ...
      pragma Volatile_Full_Access (FDCAN_NDAT1);
      --  FDCAN New Data 2 Register
      FDCAN_NDAT2  : aliased FDCAN_NDAT2_Register;
      pragma Volatile_Full_Access (FDCAN_NDAT2);
      --  FDCAN Rx FIFO 0 Configuration Register
      FDCAN_RXF0C  : aliased FDCAN_RXF0C_Register;
      pragma Volatile_Full_Access (FDCAN_RXF0C);
      --  FDCAN Rx FIFO 0 Status Register
      ...
      pragma Volatile_Full_Access (FDCAN_RXBC);
      --  FDCAN Rx FIFO 1 Configuration Register
      FDCAN_RXF1C  : aliased FDCAN_RXF1C_Register;
      pragma Volatile_Full_Access (FDCAN_RXF1C);
      --  FDCAN Rx FIFO 1 Status Register
      ...
      pragma Volatile_Full_Access (FDCAN_RXESC);
      --  FDCAN Tx Buffer Configuration Register
      ...
      pragma Volatile_Full_Access (FDCAN_TXESC);
      --  FDCAN Tx Buffer Request Pending Register
      FDCAN_TXBRP  : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Buffer Add Request Register
      FDCAN_TXBAR  : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Buffer Cancellation Request Register
      FDCAN_TXBCR  : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Buffer Transmission Occurred Register
      FDCAN_TXBTO  : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Buffer Cancellation Finished Register
      FDCAN_TXBCF  : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Buffer Transmission Interrupt Enable Register
      FDCAN_TXBTIE : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Buffer Cancellation Finished Interrupt Enable Register
      FDCAN_TXBCIE : aliased A0B.Types.SVD.UInt32;
      --  FDCAN Tx Event FIFO Configuration Register
      FDCAN_TXEFC  : aliased FDCAN_TXEFC_Register;
      pragma Volatile_Full_Access (FDCAN_TXEFC);
      --  FDCAN Tx Event FIFO Status Register
      ...
      pragma Volatile_Full_Access (FDCAN_TTTMC);
      --  FDCAN TT Reference Message Configuration Register
      FDCAN_TTRMC  : aliased FDCAN_TTRMC_Register;
      pragma Volatile_Full_Access (FDCAN_TTRMC);
      --  FDCAN TT Operation Configuration Register
      FDCAN_TTOCF  : aliased FDCAN_TTOCF_Register;
      pragma Volatile_Full_Access (FDCAN_TTOCF);
      --  FDCAN TT Matrix Limits Register
      FDCAN_TTMLM  : aliased FDCAN_TTMLM_Register;
      pragma Volatile_Full_Access (FDCAN_TTMLM);
      --  FDCAN TUR Configuration Register
      FDCAN_TURCF  : aliased FDCAN_TURCF_Register;
      pragma Volatile_Full_Access (FDCAN_TURCF);
      --  FDCAN TT Operation Control Register
      FDCAN_TTOCN  : aliased FDCAN_TTOCN_Register;
      pragma Volatile_Full_Access (FDCAN_TTOCN);
      --  FDCAN TT Global Time Preset Register
      CAN_TTGTP    : aliased CAN_TTGTP_Register;
      pragma Volatile_Full_Access (CAN_TTGTP);
      --  FDCAN TT Time Mark Register
      FDCAN_TTTMK  : aliased FDCAN_TTTMK_Register;
      pragma Volatile_Full_Access (FDCAN_TTTMK);
      --  FDCAN TT Interrupt Register
      FDCAN_TTIR   : aliased FDCAN_TTIR_Register;
      pragma Volatile_Full_Access (FDCAN_TTIR);
      --  FDCAN TT Interrupt Enable Register
      FDCAN_TTIE   : aliased FDCAN_TTIE_Register;
      pragma Volatile_Full_Access (FDCAN_TTIE);
      --  FDCAN TT Interrupt Line Select Register
      FDCAN_TTILS  : aliased FDCAN_TTILS_Register;
      pragma Volatile_Full_Access (FDCAN_TTILS);
      --  FDCAN TT Operation Status Register
      FDCAN_TTOST  : aliased FDCAN_TTOST_Register;
      pragma Volatile_Full_Access (FDCAN_TTOST);
      --  FDCAN TUR Numerator Actual Register
      FDCAN_TURNA  : aliased FDCAN_TURNA_Register;
      pragma Volatile_Full_Access (FDCAN_TURNA);
      --  FDCAN TT Local and Global Time Register
      FDCAN_TTLGT  : aliased FDCAN_TTLGT_Register;
      pragma Volatile_Full_Access (FDCAN_TTLGT);
      --  FDCAN TT Cycle Time and Count Register
      FDCAN_TTCTC  : aliased FDCAN_TTCTC_Register;
      pragma Volatile_Full_Access (FDCAN_TTCTC);
      --  FDCAN TT Capture Time Register
      FDCAN_TTCPT  : aliased FDCAN_TTCPT_Register;
      pragma Volatile_Full_Access (FDCAN_TTCPT);
      --  FDCAN TT Cycle Sync Mark Register
      FDCAN_TTCSM  : aliased FDCAN_TTCSM_Register;
      pragma Volatile_Full_Access (FDCAN_TTCSM);
      --  FDCAN TT Trigger Select Register
      FDCAN_TTTS   : aliased FDCAN_TTTS_Register;
      pragma Volatile_Full_Access (FDCAN_TTTS);
   end record
     with Volatile;
