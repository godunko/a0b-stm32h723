...
package A0B.STM32H723.SVD.LPTIM is
   pragma Preelaborate;
   ...
   subtype CFGR_TRIGSEL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype CFGR2_IN1SEL_Field is A0B.Types.SVD.UInt2;
   subtype CFGR2_IN2SEL_Field is A0B.Types.SVD.UInt2;
