...
package A0B.STM32H723.SVD.LPUART is
   pragma Preelaborate;
   ...
   subtype CR1_DEDT_Field is A0B.Types.SVD.UInt5;
   subtype CR1_DEAT_Field is A0B.Types.SVD.UInt5;
   ...
   subtype CR2_ADD_Field is A0B.Types.SVD.Byte;
