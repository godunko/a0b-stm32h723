...
package A0B.SVD.STM32H723.PSSI is
   pragma Preelaborate;
...
--  from/to PSSI_DR.
   ...
   type PSSI_CR_Register is record
      ...
      --  OUTEN.
      CKPOL          : PSSI_CR_CKPOL_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  Data enable (PSSI_DE) polarity This bit indicates the level on the
      --  PSSI_DE pin when the data are not valid on the parallel interface.
      DEPOL          : PSSI_CR_DEPOL_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  unspecified
      ...
      RDYPOL         : PSSI_CR_RDYPOL_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  unspecified
      Reserved_9_9   : A0B.Types.SVD.Bit := 16#0#;
      --  Extended data mode
      EDM            : PSSI_CR_EDM_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  unspecified
      ...
      ENABLE         : PSSI_CR_ENABLE_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  unspecified
      ...
      DERDYCFG       : PSSI_CR_DERDYCFG_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  unspecified
      Reserved_21_29 : A0B.Types.SVD.UInt9 := 16#0#;
      --  DMA enable bit
      DMAEN          : PSSI_CR_DMAEN_Field := A0B.SVD.STM32H723.PSSI.B_0x1;
      --  Data direction selection bit
      OUTEN          : PSSI_CR_OUTEN_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
   end record
...
--  occurred.
   ...
   type PSSI_IER_Register is record
      ...
      --  Data buffer overrun/underrun interrupt enable
      OVR_IE        : PSSI_IER_OVR_IE_Field := A0B.SVD.STM32H723.PSSI.B_0x0;
      --  unspecified
