...
package A0B.STM32H723.SVD.SDMMC is
   pragma Preelaborate;
   ...
   subtype SDMMC_POWER_PWRCTRL_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SDMMC_CLKCR_CLKDIV_Field is A0B.Types.SVD.UInt10;
   subtype SDMMC_CLKCR_WIDBUS_Field is A0B.Types.SVD.UInt2;
   subtype SDMMC_CLKCR_SELCLKRX_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SDMMC_CMDR_CMDINDEX_Field is A0B.Types.SVD.UInt6;
   subtype SDMMC_CMDR_WAITRESP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SDMMC_RESPCMDR_RESPCMD_Field is A0B.Types.SVD.UInt6;
   ...
   subtype SDMMC_DLENR_DATALENGTH_Field is A0B.Types.SVD.UInt25;
   ...
   subtype SDMMC_DCTRL_DTMODE_Field is A0B.Types.SVD.UInt2;
   subtype SDMMC_DCTRL_DBLOCKSIZE_Field is A0B.Types.SVD.UInt4;
   ...
   subtype SDMMC_DCNTR_DATACOUNT_Field is A0B.Types.SVD.UInt25;
   ...
   subtype SDMMC_ACKTIMER_ACKTIME_Field is A0B.Types.SVD.UInt25;
   ...
   subtype SDMMC_IDMABSIZER_IDMABNDT_Field is A0B.Types.SVD.Byte;
   ...
   type SDMMC_Peripheral is record
      ...
      pragma Volatile_Full_Access (SDMMC_CMDR);
      --  SDMMC command response register
      SDMMC_RESPCMDR   : aliased SDMMC_RESPCMDR_Register;
      pragma Volatile_Full_Access (SDMMC_RESPCMDR);
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP1R     : aliased A0B.Types.SVD.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP2R     : aliased A0B.Types.SVD.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP3R     : aliased A0B.Types.SVD.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      SDMMC_RESP4R     : aliased A0B.Types.SVD.UInt32;
      ...
      --  set.
      SDMMC_DTIMER     : aliased A0B.Types.SVD.UInt32;
      --  The SDMMC_DLENR register contains the number of data bytes to be
      --  transferred. The value is loaded into the data counter when data
      --  transfer starts.
      SDMMC_DLENR      : aliased SDMMC_DLENR_Register;
      pragma Volatile_Full_Access (SDMMC_DLENR);
      --  The SDMMC_DCTRL register control the data path state machine (DPSM).
      SDMMC_DCTRL      : aliased SDMMC_DCTRL_Register;
      pragma Volatile_Full_Access (SDMMC_DCTRL);
      ...
      pragma Volatile_Full_Access (SDMMC_DCNTR);
      ...
      pragma Volatile_Full_Access (SDMMC_STAR);
      --  The SDMMC_ICR register is a write-only register. Writing a bit with 1
      --  clears the corresponding bit in the SDMMC_STAR status register.
      SDMMC_ICR        : aliased SDMMC_ICR_Register;
      pragma Volatile_Full_Access (SDMMC_ICR);
      --  The interrupt mask register determines which status flags generate an
      --  interrupt request by setting the corresponding bit to 1.
      SDMMC_MASKR      : aliased SDMMC_MASKR_Register;
      pragma Volatile_Full_Access (SDMMC_MASKR);
      ...
      pragma Volatile_Full_Access (SDMMC_ACKTIMER);
      --  The receive and transmit FIFOs can be read or written as 32-bit wide
      ...
      SDMMC_FIFOR      : aliased A0B.Types.SVD.UInt32;
   end record
     with Volatile;
