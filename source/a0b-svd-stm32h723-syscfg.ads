...
package A0B.SVD.STM32H723.SYSCFG is
   pragma Preelaborate;
   ...
   subtype PMCR_EPIS_Field is A0B.Types.SVD.UInt3;
   ...
   type PMCR_Register is record
      ...
      --  unspecified
      Reserved_9_20  : A0B.Types.SVD.UInt12 := 16#0#;
   ...
   subtype CCVR_NCV_Field is A0B.Types.SVD.UInt4;
   subtype CCVR_PCV_Field is A0B.Types.SVD.UInt4;
   ...
   subtype CCCR_NCC_Field is A0B.Types.SVD.UInt4;
   subtype CCCR_PCC_Field is A0B.Types.SVD.UInt4;
   ...
   subtype PKGR_PKG_Field is A0B.Types.SVD.UInt4;
   ...
   subtype UR0_RDP_Field is A0B.Types.SVD.Byte;
   ...
   subtype UR2_BORH_Field is A0B.Types.SVD.UInt2;
   subtype UR2_BOOT_ADD0_Field is A0B.Types.SVD.UInt16;
   ...
   subtype UR3_BOOT_ADD1_Field is A0B.Types.SVD.UInt16;
   ...
   type UR4_Register is record
      --  unspecified
      Reserved_0_15  : A0B.Types.SVD.UInt16;
   ...
   subtype UR5_WRPN_1_Field is A0B.Types.SVD.Byte;
   ...
   subtype UR6_PA_BEG_1_Field is A0B.Types.SVD.UInt12;
   subtype UR6_PA_END_1_Field is A0B.Types.SVD.UInt12;
   ...
   subtype UR7_SA_BEG_1_Field is A0B.Types.SVD.UInt12;
   subtype UR7_SA_END_1_Field is A0B.Types.SVD.UInt12;
   ...
   subtype UR9_WRPN_2_Field is A0B.Types.SVD.Byte;
   subtype UR9_PA_BEG_2_Field is A0B.Types.SVD.UInt12;
   ...
   subtype UR10_PA_END_2_Field is A0B.Types.SVD.UInt12;
   subtype UR10_SA_BEG_2_Field is A0B.Types.SVD.UInt12;
   ...
   subtype UR11_SA_END_2_Field is A0B.Types.SVD.UInt12;
   ...
   subtype UR13_SDRS_Field is A0B.Types.SVD.UInt2;
   ...
   type SYSCFG_Peripheral is record
      ...
      pragma Volatile_Full_Access (PMCR);
      --  external interrupt configuration register 1
      ...
      pragma Volatile_Full_Access (CCCSR);
      --  SYSCFG compensation cell value register
      CCVR    : aliased CCVR_Register;
      pragma Volatile_Full_Access (CCVR);
      --  SYSCFG compensation cell code register
      CCCR    : aliased CCCR_Register;
      pragma Volatile_Full_Access (CCCR);
      --  SYSCFG package register
      PKGR    : aliased PKGR_Register;
      pragma Volatile_Full_Access (PKGR);
      --  SYSCFG user register 0
      UR0     : aliased UR0_Register;
      pragma Volatile_Full_Access (UR0);
      --  SYSCFG user register 2
      UR2     : aliased UR2_Register;
      pragma Volatile_Full_Access (UR2);
      --  SYSCFG user register 3
      UR3     : aliased UR3_Register;
      pragma Volatile_Full_Access (UR3);
      --  SYSCFG user register 4
      UR4     : aliased UR4_Register;
      pragma Volatile_Full_Access (UR4);
      --  SYSCFG user register 5
      UR5     : aliased UR5_Register;
      pragma Volatile_Full_Access (UR5);
      --  SYSCFG user register 6
      UR6     : aliased UR6_Register;
      pragma Volatile_Full_Access (UR6);
      --  SYSCFG user register 7
      UR7     : aliased UR7_Register;
      pragma Volatile_Full_Access (UR7);
      --  SYSCFG user register 8
      UR8     : aliased UR8_Register;
      pragma Volatile_Full_Access (UR8);
      --  SYSCFG user register 9
      UR9     : aliased UR9_Register;
      pragma Volatile_Full_Access (UR9);
      --  SYSCFG user register 10
      UR10    : aliased UR10_Register;
      pragma Volatile_Full_Access (UR10);
      --  SYSCFG user register 11
      UR11    : aliased UR11_Register;
      pragma Volatile_Full_Access (UR11);
      --  SYSCFG user register 12
      UR12    : aliased UR12_Register;
      pragma Volatile_Full_Access (UR12);
      --  SYSCFG user register 13
      UR13    : aliased UR13_Register;
      pragma Volatile_Full_Access (UR13);
      --  SYSCFG user register 14
      UR14    : aliased UR14_Register;
      pragma Volatile_Full_Access (UR14);
      --  SYSCFG user register 15
      UR15    : aliased UR15_Register;
      pragma Volatile_Full_Access (UR15);
      --  SYSCFG user register 16
      UR16    : aliased UR16_Register;
      pragma Volatile_Full_Access (UR16);
      --  SYSCFG user register 17
      UR17    : aliased UR17_Register;
      pragma Volatile_Full_Access (UR17);
   end record
     with Volatile;
