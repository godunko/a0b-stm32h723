...
package A0B.STM32H723.SVD.AXI is
   pragma Preelaborate;
   ...
   subtype AXI_PERIPH_ID_4_JEP106CON_Field is A0B.Types.SVD.UInt4;
   subtype AXI_PERIPH_ID_4_KCOUNT4_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_PERIPH_ID_0_PARTNUM_Field is A0B.Types.SVD.Byte;
   ...
   subtype AXI_PERIPH_ID_1_PARTNUM_Field is A0B.Types.SVD.UInt4;
   subtype AXI_PERIPH_ID_1_JEP106I_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_PERIPH_ID_2_JEP106ID_Field is A0B.Types.SVD.UInt3;
   subtype AXI_PERIPH_ID_2_REVISION_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_PERIPH_ID_3_CUST_MOD_NUM_Field is A0B.Types.SVD.UInt4;
   subtype AXI_PERIPH_ID_3_REV_AND_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_COMP_ID_0_PREAMBLE_Field is A0B.Types.SVD.Byte;
   ...
   subtype AXI_COMP_ID_1_PREAMBLE_Field is A0B.Types.SVD.UInt4;
   subtype AXI_COMP_ID_1_CLASS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_COMP_ID_2_PREAMBLE_Field is A0B.Types.SVD.Byte;
   ...
   subtype AXI_COMP_ID_3_PREAMBLE_Field is A0B.Types.SVD.Byte;
   ...
   type AXI_TARG1_FN_MOD_ISS_BM_Register is record
      ...
      --  unspecified
      Reserved_2_31      : A0B.Types.SVD.UInt30 := 16#1#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   type AXI_TARG1_FN_MOD2_Register is record
      ...
      --  unspecified
      Reserved_1_31 : A0B.Types.SVD.UInt31 := 16#2#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype AXI_INI1_READ_QOS_AR_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI1_WRITE_QOS_AW_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI2_READ_QOS_AR_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI2_WRITE_QOS_AW_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI3_READ_QOS_AR_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI3_WRITE_QOS_AW_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI4_READ_QOS_AR_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI4_WRITE_QOS_AW_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI5_READ_QOS_AR_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI5_WRITE_QOS_AW_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI6_READ_QOS_AR_QOS_Field is A0B.Types.SVD.UInt4;
   ...
   subtype AXI_INI6_WRITE_QOS_AW_QOS_Field is A0B.Types.SVD.UInt4;
