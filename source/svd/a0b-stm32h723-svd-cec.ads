...
package A0B.STM32H723.SVD.CEC is
   pragma Preelaborate;
   ...
   subtype CFGR_SFT_Field is A0B.Types.SVD.UInt3;
   subtype CFGR_OAR_Field is A0B.Types.SVD.UInt15;
   ...
   subtype TXDR_TXD_Field is A0B.Types.SVD.Byte;
   ...
   subtype RXDR_RXD_Field is A0B.Types.SVD.Byte;
