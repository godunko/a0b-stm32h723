...
package A0B.STM32H723.SVD.SWPMI is
   pragma Preelaborate;
   ...
   subtype BRR_BR_Field is A0B.Types.SVD.Byte;
   ...
   subtype RFL_RFL_Field is A0B.Types.SVD.UInt5;
   ...
   type SWPMI_Peripheral is record
      ...
      pragma Volatile_Full_Access (RFL);
