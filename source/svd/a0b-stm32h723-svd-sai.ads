...
package A0B.STM32H723.SVD.SAI is
   pragma Preelaborate;
   ...
   subtype SAI_GCR_SYNCIN_Field is A0B.Types.SVD.UInt2;
   subtype SAI_GCR_SYNCOUT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SAI_ACR1_MODE_Field is A0B.Types.SVD.UInt2;
   subtype SAI_ACR1_PRTCFG_Field is A0B.Types.SVD.UInt2;
   subtype SAI_ACR1_DS_Field is A0B.Types.SVD.UInt3;
   subtype SAI_ACR1_SYNCEN_Field is A0B.Types.SVD.UInt2;
   subtype SAI_ACR1_MCKDIV_Field is A0B.Types.SVD.UInt4;
   ...
   subtype SAI_ACR2_FTH_Field is A0B.Types.SVD.UInt3;
   subtype SAI_ACR2_MUTECNT_Field is A0B.Types.SVD.UInt6;
   subtype SAI_ACR2_COMP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SAI_AFRCR_FRL_Field is A0B.Types.SVD.Byte;
   subtype SAI_AFRCR_FSALL_Field is A0B.Types.SVD.UInt7;
   ...
   subtype SAI_ASLOTR_FBOFF_Field is A0B.Types.SVD.UInt5;
   subtype SAI_ASLOTR_SLOTSZ_Field is A0B.Types.SVD.UInt2;
   subtype SAI_ASLOTR_NBSLOT_Field is A0B.Types.SVD.UInt4;
   subtype SAI_ASLOTR_SLOTEN_Field is A0B.Types.SVD.UInt16;
   ...
   subtype SAI_ASR_FLVL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype SAI_BCR1_MODE_Field is A0B.Types.SVD.UInt2;
   subtype SAI_BCR1_PRTCFG_Field is A0B.Types.SVD.UInt2;
   subtype SAI_BCR1_DS_Field is A0B.Types.SVD.UInt3;
   subtype SAI_BCR1_SYNCEN_Field is A0B.Types.SVD.UInt2;
   subtype SAI_BCR1_MCKDIV_Field is A0B.Types.SVD.UInt4;
   ...
   subtype SAI_BCR2_FTH_Field is A0B.Types.SVD.UInt3;
   subtype SAI_BCR2_MUTECNT_Field is A0B.Types.SVD.UInt6;
   subtype SAI_BCR2_COMP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SAI_BFRCR_FRL_Field is A0B.Types.SVD.Byte;
   subtype SAI_BFRCR_FSALL_Field is A0B.Types.SVD.UInt7;
   ...
   subtype SAI_BSLOTR_FBOFF_Field is A0B.Types.SVD.UInt5;
   subtype SAI_BSLOTR_SLOTSZ_Field is A0B.Types.SVD.UInt2;
   subtype SAI_BSLOTR_NBSLOT_Field is A0B.Types.SVD.UInt4;
   subtype SAI_BSLOTR_SLOTEN_Field is A0B.Types.SVD.UInt16;
   ...
   subtype SAI_BSR_FLVL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype SAI_PDMCR_MICNBR_Field is A0B.Types.SVD.UInt2;
   ...
   subtype SAI_PDMDLY_DLYM1L_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM1R_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM2L_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM2R_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM3L_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM3R_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM4L_Field is A0B.Types.SVD.UInt3;
   subtype SAI_PDMDLY_DLYM4R_Field is A0B.Types.SVD.UInt3;
   ...
   type SAI_Peripheral is record
      ...
      pragma Volatile_Full_Access (SAI_GCR);
      --  Configuration register 1
      SAI_ACR1   : aliased SAI_ACR1_Register;
      pragma Volatile_Full_Access (SAI_ACR1);
      --  Configuration register 2
      SAI_ACR2   : aliased SAI_ACR2_Register;
      pragma Volatile_Full_Access (SAI_ACR2);
      --  This register has no meaning in AC97 and SPDIF audio protocol
      SAI_AFRCR  : aliased SAI_AFRCR_Register;
      pragma Volatile_Full_Access (SAI_AFRCR);
      --  This register has no meaning in AC97 and SPDIF audio protocol
      SAI_ASLOTR : aliased SAI_ASLOTR_Register;
      pragma Volatile_Full_Access (SAI_ASLOTR);
      --  Interrupt mask register 2
      SAI_AIM    : aliased SAI_AIM_Register;
      pragma Volatile_Full_Access (SAI_AIM);
      --  Status register
      SAI_ASR    : aliased SAI_ASR_Register;
      pragma Volatile_Full_Access (SAI_ASR);
      --  Clear flag register
      SAI_ACLRFR : aliased SAI_ACLRFR_Register;
      pragma Volatile_Full_Access (SAI_ACLRFR);
      --  Data register
      SAI_ADR    : aliased A0B.Types.SVD.UInt32;
      --  Configuration register 1
      SAI_BCR1   : aliased SAI_BCR1_Register;
      pragma Volatile_Full_Access (SAI_BCR1);
      --  Configuration register 2
      SAI_BCR2   : aliased SAI_BCR2_Register;
      pragma Volatile_Full_Access (SAI_BCR2);
      --  This register has no meaning in AC97 and SPDIF audio protocol
      SAI_BFRCR  : aliased SAI_BFRCR_Register;
      pragma Volatile_Full_Access (SAI_BFRCR);
      --  This register has no meaning in AC97 and SPDIF audio protocol
      SAI_BSLOTR : aliased SAI_BSLOTR_Register;
      pragma Volatile_Full_Access (SAI_BSLOTR);
      --  Interrupt mask register 2
      SAI_BIM    : aliased SAI_BIM_Register;
      pragma Volatile_Full_Access (SAI_BIM);
      --  Status register
      SAI_BSR    : aliased SAI_BSR_Register;
      pragma Volatile_Full_Access (SAI_BSR);
      --  Clear flag register
      SAI_BCLRFR : aliased SAI_BCLRFR_Register;
      pragma Volatile_Full_Access (SAI_BCLRFR);
      --  Data register
      SAI_BDR    : aliased A0B.Types.SVD.UInt32;
      --  PDM control register
      SAI_PDMCR  : aliased SAI_PDMCR_Register;
      pragma Volatile_Full_Access (SAI_PDMCR);
      --  PDM delay register
      SAI_PDMDLY : aliased SAI_PDMDLY_Register;
      pragma Volatile_Full_Access (SAI_PDMDLY);
   end record
     with Volatile;
