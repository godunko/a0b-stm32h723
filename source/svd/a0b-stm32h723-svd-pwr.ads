...
package A0B.STM32H723.SVD.PWR is
   pragma Preelaborate;
   ...
   subtype CR1_PLS_Field is A0B.Types.SVD.UInt3;
   subtype CR1_SVOS_Field is A0B.Types.SVD.UInt2;
   subtype CR1_ALS_Field is A0B.Types.SVD.UInt2;
   ...
   type CR1_Register is record
      ...
      --  unspecified
      Reserved_19_31 : A0B.Types.SVD.UInt13 := 16#1E00#;
   end record
   ...
   subtype CSR1_ACTVOS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype D3CR_VOS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype WKUPCR_WKUPC_Field is A0B.Types.SVD.UInt6;
   ...
   subtype WKUPEPR_WKUPPUPD_Element is A0B.Types.SVD.UInt2;
   ...
   type PWR_Peripheral is record
      ...
      pragma Volatile_Full_Access (CSR1);
      ...
      pragma Volatile_Full_Access (CPUCR);
      ...
      pragma Volatile_Full_Access (D3CR);
      ...
      pragma Volatile_Full_Access (WKUPCR);
      --  reset only by system reset, not reset by wakeup from Standby mode
      WKUPFR  : aliased WKUPFR_Register;
      pragma Volatile_Full_Access (WKUPFR);
      --  Reset only by system reset, not reset by wakeup from Standby mode
      WKUPEPR : aliased WKUPEPR_Register;
      pragma Volatile_Full_Access (WKUPEPR);
   end record
     with Volatile;
