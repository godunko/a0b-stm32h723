...
package A0B.STM32H723.SVD.Flash is
   pragma Preelaborate;
   ...
   subtype ACR_WRHIGHFREQ_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CR_SNB_Field is A0B.Types.SVD.UInt3;
   ...
   type OPTCR_Register is record
      ...
      --  unspecified
      Reserved_2_29  : A0B.Types.SVD.UInt28 := 16#0#;
   ...
   subtype OPTSR_CUR_BOR_LEV_Field is A0B.Types.SVD.UInt2;
   subtype OPTSR_CUR_RDP_Field is A0B.Types.SVD.Byte;
   subtype OPTSR_CUR_ST_RAM_SIZE_Field is A0B.Types.SVD.UInt2;
   ...
   type OPTSR_CUR_Register is record
      ...
      --  unspecified
      Reserved_22_28 : A0B.Types.SVD.UInt7 := 16#0#;
   ...
   subtype OPTSR_PRG_BOR_LEV_Field is A0B.Types.SVD.UInt2;
   subtype OPTSR_PRG_RDP_Field is A0B.Types.SVD.Byte;
   subtype OPTSR_PRG_ST_RAM_SIZE_Field is A0B.Types.SVD.UInt2;
   ...
   type OPTCCR_Register is record
      --  unspecified
      Reserved_0_29    : A0B.Types.SVD.UInt30 := 16#0#;
   ...
   subtype PRAR_CUR_PROT_AREA_START_Field is A0B.Types.SVD.UInt12;
   subtype PRAR_CUR_PROT_AREA_END_Field is A0B.Types.SVD.UInt12;

   --  FLASH protection address for bank 1
   type PRAR_CUR_Register is record
      ...
      --  unspecified
      Reserved_28_30  : A0B.Types.SVD.UInt3;
      --  Read-only. PCROP protected erase enable option status bit
      DMEP            : Boolean;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;

   for PRAR_CUR_Register use record
   ...
   subtype PRAR_PRG_PROT_AREA_START_Field is A0B.Types.SVD.UInt12;
   subtype PRAR_PRG_PROT_AREA_END_Field is A0B.Types.SVD.UInt12;

   --  FLASH protection address for bank 1
   type PRAR_PRG_Register is record
   ...
   for PRAR_PRG_Register use record
      PROT_AREA_START at 0 range 0 .. 11;
      Reserved_12_15  at 0 range 12 .. 15;
      PROT_AREA_END   at 0 range 16 .. 27;
      Reserved_28_30  at 0 range 28 .. 30;
   ...
   subtype SCAR_CUR_SEC_AREA_START_Field is A0B.Types.SVD.UInt12;
   subtype SCAR_CUR_SEC_AREA_END_Field is A0B.Types.SVD.UInt12;

   --  FLASH secure address for bank 1
   type SCAR_CUR_Register is record
   ...
   for SCAR_CUR_Register use record
   ...
   subtype SCAR_PRG_SEC_AREA_START_Field is A0B.Types.SVD.UInt12;
   subtype SCAR_PRG_SEC_AREA_END_Field is A0B.Types.SVD.UInt12;

   --  FLASH secure address for bank 1
   type SCAR_PRG_Register is record
   ...
   for SCAR_PRG_Register use record
      SEC_AREA_START at 0 range 0 .. 11;
      Reserved_12_15 at 0 range 12 .. 15;
      SEC_AREA_END   at 0 range 16 .. 27;
      Reserved_28_30 at 0 range 28 .. 30;
   ...
   subtype WPSN_CUR_WRPSn_Field is A0B.Types.SVD.Byte;

   --  FLASH write sector protection for bank 1
   type WPSN_CUR_Register is record
   ...
   for WPSN_CUR_Register use record
      WRPSn         at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   subtype WPSN_PRG_WRPSn_Field is A0B.Types.SVD.Byte;

   --  FLASH write sector protection for bank 1
   type WPSN_PRG_Register is record
   ...
   for WPSN_PRG_Register use record
      WRPSn         at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   --  BOOT_CUR_BOOT_CM_ADD array element
   subtype BOOT_CUR_BOOT_CM_ADD_Element is A0B.Types.SVD.UInt16;
   ...
   for BOOT_CUR_Register use record
      Val at 0 range 0 .. 31;
      Arr at 0 range 0 .. 31;
   end record;

   --  BOOT_PRG_BOOT_CM_ADD array element
   subtype BOOT_PRG_BOOT_CM_ADD_Element is A0B.Types.SVD.UInt16;
   ...
   for BOOT_PRG_Register use record
      Val at 0 range 0 .. 31;
      Arr at 0 range 0 .. 31;
   end record;

   subtype CRCCR_CRC_SECT_Field is A0B.Types.SVD.UInt3;
   subtype CRCCR_CRC_BURST_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CRCSADDR_CRC_START_ADDR_Field is A0B.Types.SVD.UInt18;

   --  FLASH CRC start address register for bank 1
   type CRCSADDR_Register is record
      --  unspecified
      Reserved_0_1   : A0B.Types.SVD.UInt2 := 16#0#;
   ...
   for CRCSADDR_Register use record
      Reserved_0_1   at 0 range 0 .. 1;
      CRC_START_ADDR at 0 range 2 .. 19;
      Reserved_20_31 at 0 range 20 .. 31;
   end record;

   subtype CRCEADDR_CRC_END_ADDR_Field is A0B.Types.SVD.UInt18;

   --  FLASH CRC end address register for bank 1
   type CRCEADDR_Register is record
      --  unspecified
      Reserved_0_1   : A0B.Types.SVD.UInt2 := 16#0#;
   ...
   for CRCEADDR_Register use record
      Reserved_0_1   at 0 range 0 .. 1;
      CRC_END_ADDR   at 0 range 2 .. 19;
      Reserved_20_31 at 0 range 20 .. 31;
   end record;

   subtype ECC_FAR_FAIL_ECC_ADDR_Field is A0B.Types.SVD.UInt15;

   --  FLASH ECC fail address for bank 1
   type ECC_FAR_Register is record
   ...
   for ECC_FAR_Register use record
      FAIL_ECC_ADDR  at 0 range 0 .. 14;
      Reserved_15_31 at 0 range 15 .. 31;
   end record;

   subtype OPTSR2_CUR_TCM_AXI_SHARED_Field is A0B.Types.SVD.UInt2;

   --  FLASH ECC fail address for bank 1
   type OPTSR2_CUR_Register is record
   ...
   for OPTSR2_CUR_Register use record
      TCM_AXI_SHARED at 0 range 0 .. 1;
      CPUFREQ_BOOST  at 0 range 2 .. 2;
      Reserved_3_31  at 0 range 3 .. 31;
   end record;

   subtype OPTSR2_PRG_TCM_AXI_SHARED_Field is A0B.Types.SVD.UInt2;

   --  FLASH ECC fail address for bank 1
   type OPTSR2_PRG_Register is record
   ...
   for OPTSR2_PRG_Register use record
      TCM_AXI_SHARED at 0 range 0 .. 1;
      CPUFREQ_BOOST  at 0 range 2 .. 2;
      Reserved_3_31  at 0 range 3 .. 31;
   end record;
   ...
   type Flash_Peripheral is record
      ...
      pragma Volatile_Full_Access (OPTSR_CUR);
      --  FLASH option status register
      OPTSR_PRG  : aliased OPTSR_PRG_Register;
      pragma Volatile_Full_Access (OPTSR_PRG);
      --  FLASH option clear control register
      OPTCCR     : aliased OPTCCR_Register;
      pragma Volatile_Full_Access (OPTCCR);
      --  FLASH protection address for bank 1
      PRAR_CUR   : aliased PRAR_CUR_Register;
      pragma Volatile_Full_Access (PRAR_CUR);
      --  FLASH protection address for bank 1
      PRAR_PRG   : aliased PRAR_PRG_Register;
      pragma Volatile_Full_Access (PRAR_PRG);
      --  FLASH secure address for bank 1
      SCAR_CUR   : aliased SCAR_CUR_Register;
      pragma Volatile_Full_Access (SCAR_CUR);
      --  FLASH secure address for bank 1
      SCAR_PRG   : aliased SCAR_PRG_Register;
      pragma Volatile_Full_Access (SCAR_PRG);
      --  FLASH write sector protection for bank 1
      WPSN_CUR   : aliased WPSN_CUR_Register;
      pragma Volatile_Full_Access (WPSN_CUR);
      --  FLASH write sector protection for bank 1
      WPSN_PRG   : aliased WPSN_PRG_Register;
      pragma Volatile_Full_Access (WPSN_PRG);
      --  FLASH register with boot address
      BOOT_CUR   : aliased BOOT_CUR_Register;
      pragma Volatile_Full_Access (BOOT_CUR);
      --  FLASH register with boot address
      BOOT_PRG   : aliased BOOT_PRG_Register;
      pragma Volatile_Full_Access (BOOT_PRG);
      --  FLASH CRC control register for bank 1
      CRCCR      : aliased CRCCR_Register;
      pragma Volatile_Full_Access (CRCCR);
      --  FLASH CRC start address register for bank 1
      CRCSADDR   : aliased CRCSADDR_Register;
      pragma Volatile_Full_Access (CRCSADDR);
      --  FLASH CRC end address register for bank 1
      CRCEADDR   : aliased CRCEADDR_Register;
      pragma Volatile_Full_Access (CRCEADDR);
      --  FLASH CRC data register
      CRCDATAR   : aliased A0B.Types.SVD.UInt32;
      --  FLASH ECC fail address for bank 1
      ECC_FAR    : aliased ECC_FAR_Register;
      pragma Volatile_Full_Access (ECC_FAR);
      --  FLASH ECC fail address for bank 1
      OPTSR2_CUR : aliased OPTSR2_CUR_Register;
      pragma Volatile_Full_Access (OPTSR2_CUR);
      --  FLASH ECC fail address for bank 1
      OPTSR2_PRG : aliased OPTSR2_PRG_Register;
      pragma Volatile_Full_Access (OPTSR2_PRG);
   end record
     with Volatile;
